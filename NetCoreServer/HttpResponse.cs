...
public class HttpResponse
{
    ...
    public HttpResponse SetCookie(string name, string value, int maxAge = 86400, string path = "", string domain = "", bool secure = true,
        bool strict = true, bool httpOnly = true)
    {
        var key = "Set-Cookie";
    ...
    {
        return MakeTraceResponse(request.Cache.AsSpan());
    }
